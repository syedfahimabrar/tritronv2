...
namespace JudgeCompiler
{
    public class cppCompiler
    {
        ...
        public cppCompiler(byte[] content, Guid Id,string filep)
        {
        ...
        public string ExecuteCommand()
        {
                ...
                System.Diagnostics.ProcessStartInfo
            {
                ...
                FileName = Environment.GetEnvironmentVariable("TritronCpp") ?? throw new InvalidOperationException("TritronCpp Environment Variable not settuped"),// ConfigurationManager.AppSettings["gccPath"],
                //"cmd.exe";
